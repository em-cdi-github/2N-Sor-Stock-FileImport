...
CREATE OR REPLACE PROCEDURE SOR_AND_STOCK{{ sufix }}.DATA.DATA_IMPORT_ALLTRADE("SOURCE_TABLE" VARCHAR, "FINAL_TABLE" VARCHAR, "TYPE" VARCHAR, "PROFILE_NAME" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS OWNER
AS 'DECLARE
...
BEGIN
    IF (UPPER(TYPE) = $$SOR$$) THEN
        ...
        SELECT 
            ...
            TRY_TO_DATE(DATE_OF_SALE)                           AS DATE_OF_SALES,
            CUSTOMER_NAME                                       AS CUSTOMER_NAME,
            $$NA$$                                              AS CUSTOMER_TAX_ID,
            $$NA$$                                              AS CUSTOMER_VAT,
            "2N_REFERENCE_NUMBER"                               AS ITEM_REFERENCE_NUMBER,
