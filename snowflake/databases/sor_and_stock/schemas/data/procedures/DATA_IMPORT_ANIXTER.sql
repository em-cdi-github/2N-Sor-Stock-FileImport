...
CREATE OR REPLACE PROCEDURE SOR_AND_STOCK{{ sufix }}.DATA.DATA_IMPORT_ANIXTER("SOURCE_TABLE" VARCHAR, "FINAL_TABLE" VARCHAR, "TYPE" VARCHAR, "PROFILE_NAME" VARCHAR)
RETURNS VARCHAR
LANGUAGE SQL
EXECUTE AS OWNER
AS 'DECLARE
...
BEGIN
    IF (UPPER(TYPE) = $$SOR$$) THEN
        ...
        SELECT 
            ...
            TRY_TO_DATE(CONCAT(FISCAL_YEAR,$$-$$,FISCAL_MONTH),$$YYYY-MM$$)            AS DATE_OF_SALES,
            "SHIP-TO_CUSTOMER_NAME"                             AS CUSTOMER_NAME,
